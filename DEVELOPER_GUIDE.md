...
│   ├── layout.tsx                      # Root layout (Inter, ThemeProvider, AppShell, Toaster, PwaRegister)
│   ├── manifest.ts                     # PWA web app manifest (MetadataRoute.Manifest)
│   ├── icon.tsx                        # Generated favicon (next/og ImageResponse)
│   ├── apple-icon.tsx                  # Generated apple-touch-icon (next/og ImageResponse)
│   ├── offline/                        # PWA offline fallback page (served by sw.js)
...
│   └── pwa-register.tsx                # Registers public/sw.js on the client (production only)
├── hooks/
...
├── scripts/
│   ├── bundle-merge-worker.mjs         # Bundles the merge web worker (build:worker)
│   └── generate-icons.mjs              # Rasterizes PWA icons via sharp (build:icons)
├── public/
│   ├── sw.js                           # Hand-written service worker (cache-first + offline)
│   ├── icon-192.png                    # PWA icon (generated by build:icons)
│   ├── icon-512.png                    # PWA icon (generated by build:icons)
│   ├── icon-512-maskable.png           # PWA maskable icon (generated by build:icons)
│   └── workers/
