...
type PageGridProps = {
  ...
  onOrderedKeptChange?: (orderedKeptIndices: number[]) => void;
  loading?: boolean;
};
...
function SortablePageThumb({
  ...
  return (
    ...
    >
      <IconTouchButton
        type="button"
        className="absolute top-0 right-0 z-10 min-w-12 min-h-12 bg-background/90 hover:bg-destructive/10 pointer-events-auto"
...
export function PageGrid({
  ...
  useEffect(() => {
    ...
    onOrderedKeptChange?.(getOrderedKeptIndices(thumbs, removed));
  }, [thumbs, removed, onSummaryChange, onOrderedKeptChange]);
    ...
    function handleConfirm() {
      onConfirm?.(getOrderedKeptIndices(thumbs, removed));
    }
